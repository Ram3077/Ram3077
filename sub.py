...
CLIENT_SECRET_FILE = 'C:\\Users\\selva\\Ram3077\\client_secret_672560470766-r8jre2vneh1h8nch7qn0anldtrhh3j38.apps.googleusercontent.com.json'
APPLICATION_NAME = 'Gmail API Python Send Email'

def get_credentials(user_email):
    # home_dir = '/home/selvaprakash/glance/'
    home_dir = 'C:\\Users\\selva\\Ram3077'
...
def read_msg(user_email):
    ...
    # df_sum_1=df.groupby('subject').size()
    # print('subject_col------------------------------',df_sum_1)

    dup=pd.pivot_table(df,index=('sender','date','subject'),aggfunc='count')
    print(type(dup))
    print('d',dup)
    ...
    dup.reset_index().to_json('C:\\Users\\Selva\\Ram3077\\mailjsonformat.json',orient='records')
    print('saved json')
